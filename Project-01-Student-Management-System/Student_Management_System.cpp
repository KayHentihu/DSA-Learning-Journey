...
class ManagementSystem{
    ...
    public:
    	...
    	void tampilkan_antrean(){ // Display Queue
    		cout << "\n=== TAMPILKAN ANTREAN ===\n";
    		if(front > rear){
    			cout << "\nAntrean kosong!!\n";
			}else{
		...
		void tampilkan_riwayat(){ // berdasarkan terbaru 
			cout << "\n=== RIWAYAT AKTIVITAS ===\n";
		...
		void cari_mahasiswa(){
			string nimCari;
			bool ditemukan = false; // flag untuk cek ketemu tidak yang dicari
		...
		void urut_berdasarkan_nilai(){ // pakai selection sort mode descending
